    ...
    <div style="text-align: center">
        <div class="button-group">
            ...
            <? if (ForumPerm::has('pdfexport', $seminar_id) && $section == 'index') : ?>
                <?= Studip\LinkButton::create('Beitr�ge als PDF exportieren', PluginEngine::getLink('coreforum/index/pdfexport')) ?>
            <? endif ?>
        </div>
    </div>
    ...
    <div style="text-align: center">
        <div id="new_entry_button" <?= $this->flash['new_entry_title'] ? 'style="display: none"' : '' ?>>
            <div class="button-group">
                ...
                <? if (ForumPerm::has('pdfexport', $seminar_id)) : ?>
                <?= Studip\LinkButton::create('Beitr�ge als PDF exportieren', PluginEngine::getLink('coreforum/index/pdfexport/' . $topic_id)) ?>
                <? endif ?>
            </div>
        </div>
