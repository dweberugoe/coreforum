        ...
        <div class="posting bg2">
            ...
            <div class="buttons">
                <div class="button-group">
                    ...
                    <?= Studip\LinkButton::create('Als Sticky Thread markieren', "javascript:", array('tabindex' => '6', 'class' => 'js')) ?>
                    Als Sticky Thread markieren <input type="checkbox" name="sticky" value="1">
                    </div>
            </div>
